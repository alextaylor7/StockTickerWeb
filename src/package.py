with open(r'index.html', 'r') as file:
    ...
    with open('index.css', 'r') as index_css:
        index_css_data = index_css.read()
        main_data = main_data.replace("<link rel=\"stylesheet\" href=\"index.css\">", "<style>" + index_css_data + "</style>")

    with open(r'StockTicker.html', 'w') as output_file:
